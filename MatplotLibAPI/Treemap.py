...
def aplot_treemap(
    ...
    color : str, optional
        Column used for coloring. Default is None.
    sort_by : str, optional
        Column used to sort data. Default is None.
    ...
    g = go.Treemap(data, root_color=style.background_color)
...
def fplot_treemap(
    ...
    fig : go.Figure, optional
        Existing figure to add the treemap to. Default is None.
