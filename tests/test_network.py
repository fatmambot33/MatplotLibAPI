...
def test_network_graph_fplot_w_returns_pyplot_managed_figure(load_sample_df):
    """Return a pyplot-managed figure when calling ``NetworkGraph.fplot_w``."""
    ...
    fig = graph.fplot_w(edge_weight_col="distance_km")
